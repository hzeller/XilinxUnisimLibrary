...
`ifndef XIL_XECLIB
  always @(trig_attr) begin
    #1;
    if ((attr_test == 1'b1) || ((REFCLK_HROW_CK_SEL_REG != 0) && (REFCLK_HROW_CK_SEL_REG != 1) && (
                                REFCLK_HROW_CK_SEL_REG != 2) && (REFCLK_HROW_CK_SEL_REG != 3))
        ) begin
      $display(
    ...
    if ((attr_test == 1'b1) || ((REFCLK_ICNTL_RX_REG != 0) && (REFCLK_ICNTL_RX_REG != 1) && (
                                REFCLK_ICNTL_RX_REG != 2) && (REFCLK_ICNTL_RX_REG != 3))) begin
      $display(
...
`ifndef XIL_XECLIB
  ...
  specify (I => O) = (100: 100: 100, 100: 100: 100); (I => ODIV2) = (100: 100: 100, 100: 100: 100);
      (IB => O) = (0: 0: 0, 0: 0: 0); (IB => ODIV2) = (0: 0: 0, 0: 0: 0); specparam PATHPULSE$ = 0;
      endspecify
  //`endif
`endif
