...
`endif
  ...
  initial begin
    ...
    case (DATA_CTL_N)
      ...
      default: begin
        $display(
            "Attribute Syntax Error : The Attribute DATA_CTL_N on %s instance %m is set to %s.  Legal values for this attribute are FALSE or TRUE.",
            MODULE_NAME, DATA_CTL_N);
        #1 $finish;
      end
    endcase
    ...
    case (DATA_RD_CYCLES)
      ...
      default: begin
        $display(
            "Attribute Syntax Error : The Attribute DATA_RD_CYCLES on %s instance %m is set to %s.  Legal values for this attribute are FALSE or TRUE.",
            MODULE_NAME, DATA_RD_CYCLES);
        #1 $finish;
      end
    endcase
