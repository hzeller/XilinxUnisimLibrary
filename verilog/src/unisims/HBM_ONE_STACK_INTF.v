...
`ifndef XIL_XECLIB
  always @(trig_attr) begin
    ...
    if ((attr_test == 1'b1) || ((MC_ENABLE_APB_REG != "FALSE") && (MC_ENABLE_APB_REG != "TRUE"))
        ) begin
    ...
    if ((attr_test == 1'b1) || ((PHY_ENABLE_APB_REG != "FALSE") && (PHY_ENABLE_APB_REG != "TRUE"))
        ) begin
    ...
    if ((attr_test == 1'b1) || ((SWITCH_ENABLE_REG != "FALSE") && (SWITCH_ENABLE_REG != "TRUE"))
        ) begin
