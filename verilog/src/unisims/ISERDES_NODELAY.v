...
module ISERDES_NODELAY (
  ...
  initial begin
    ...
    if ((INTERFACE_TYPE == "MEMORY") && (BITSLIP_ENABLE == "TRUE")) begin
      $display(
          "Attribute Syntax Error: BITSLIP_ENABLE is currently set to TRUE when INTERFACE_TYPE is set to MEMORY. This is an invalid configuration."
          );
      #1 $finish;
    end else if ((INTERFACE_TYPE == "NETWORKING") && (BITSLIP_ENABLE == "FALSE")) begin
      $display(
          "Attribute Syntax Error: BITSLIP_ENABLE is currently set to FALSE when INTERFACE_TYPE is set to NETWORKING. If BITSLIP is not intended to be used, please set BITSLIP_ENABLE to TRUE and tie the BITSLIP port to ground."
          );
      #1 $finish;
    end
    ...
    case (SERDES_MODE)
      ...
      default: begin
        $display(
            "Attribute Syntax Error : The attribute SERDES_MODE on ISERDES_NODELAY instance %m is set to %s.  Legal values for this attribute are MASTER or SLAVE"
                , SERDES_MODE);
        #1 $finish;
      end
    ...
    case (DATA_RATE)
      ...
      default: begin
        $display(
            "Attribute Syntax Error : The attribute DATA_RATE on ISERDES_NODELAY instance %m is set to %s.  Legal values for this attribute are SDR or DDR"
                , DATA_RATE);
        #1 $finish;
      end
    ...
    case (BITSLIP_ENABLE)
      ...
      default: begin
        $display(
            "Attribute Syntax Error : The attribute BITSLIP_ENABLE on ISERDES_NODELAY instance %m is set to %s.  Legal values for this attribute are FALSE or TRUE"
                , BITSLIP_ENABLE);
        #1 $finish;
      end
    ...
    case (DATA_WIDTH)
      ...
      default: begin
        $display(
            "Attribute Syntax Error : The attribute DATA_WIDTH on ISERDES_NODELAY instance %m is set to %d.  Legal values for this attribute are 2, 3, 4, 5, 6, 7, 8, or 10"
                , DATA_WIDTH);
        #1 $finish;
      end
    ...
    case (NUM_CE)
      ...
      default: begin
        $display(
            "Attribute Syntax Error : The attribute NUM_CE on ISERDES_NODELAY instance %m is set to %d.  Legal values for this attribute are 1 or 2"
                , NUM_CE);
        #1 $finish;
      end
  ...
  always @(posedge clk_in or posedge rev_in or posedge sr_in or posedge rev_in_AND_NOT_sr_in or
           posedge NOT_rev_in_AND_sr_in) begin
    // 1st flop in rank 1 that is full featured

    if (sr_in == 1'b1 & !(rev_in == 1'b1 & SRVAL_Q1 == 1'b1)) q1rnk1 <= #ffinp SRVAL_Q1;

    else if (rev_in == 1'b1) q1rnk1 <= #ffinp !SRVAL_Q1;

    else if (ice == 1'b1) q1rnk1 <= #ffinp o_delay;
  ...
  // Asynchronous Operation
  always @(posedge clkb_in or posedge sr_in or posedge rev_in or posedge rev_in_AND_NOT_sr_in or
           posedge NOT_rev_in_AND_sr_in) begin

    if (sr_in == 1'b1 & !(rev_in == 1'b1 & SRVAL_Q2 == 1'b1)) q2nrnk1 <= #ffinp SRVAL_Q2;

    else if (rev_in == 1'b1) q2nrnk1 <= #ffinp !SRVAL_Q2;

    else if (ice == 1'b1) q2nrnk1 <= #ffinp o_delay;
  ...
  // Asynchronous Operation
  always @(posedge q2pmux or posedge sr_in or posedge rev_in or posedge rev_in_AND_NOT_sr_in or
           posedge NOT_rev_in_AND_sr_in) begin

    if (sr_in == 1'b1 & !(rev_in == 1'b1 & SRVAL_Q4 == 1'b1)) q2prnk1 <= #ffinp SRVAL_Q4;

    else if (rev_in == 1'b1) q2prnk1 <= #ffinp !SRVAL_Q4;

    else if (ice == 1'b1) q2prnk1 <= #ffinp q2nrnk1;
  ...
  // Asynchronous Operation
  always @(posedge memmux or posedge sr_in or posedge rev_in or posedge rev_in_AND_NOT_sr_in or
           posedge NOT_rev_in_AND_sr_in) begin

    if (sr_in == 1'b1 & !(rev_in == 1'b1 & SRVAL_Q3 == 1'b1)) q1prnk1 <= #ffinp SRVAL_Q3;

    else if (rev_in == 1'b1) q1prnk1 <= #ffinp !SRVAL_Q3;

    else if (ice == 1'b1) q1prnk1 <= #ffinp q1rnk1;
  ...
  always @(clk_in or oclk_in) begin
    ...
    case (INTERFACE_TYPE)
      ...
      default: begin
        $display(
            "Attribute Syntax Error : The attribute INTERFACE_TYPE on ISERDES_NODELAY instance %m is set to %s.  Legal values for this attribute are MEMORY or NETWORKING"
                , INTERFACE_TYPE);
        $finish;
      end
  ...
  always @(data_rate_int or data_width_int) begin
    ...
    casex ({data_rate_int, data_width_int})
      ...
      default: begin
        $display("DATA_WIDTH %d and DATA_RATE %s at %t is an illegal value", DATA_WIDTH, DATA_RATE,
                 $time);
        $finish;
      end
  ...
  always @(posedge qr1 or posedge clkdiv_in) begin
    ...
    end else if (bitslip_in == 1'b0) begin
  ...
  specify (CLKDIV => Q1) = (100: 100: 100, 100: 100: 100);
      ...
      (CLKDIV => Q6) = (100: 100: 100, 100: 100: 100); specparam PATHPULSE$ = 0; endspecify
