...
`endif
  ...
  initial begin
    ...
    if (!((IS_CLKARDCLK_INVERTED >= 1'b0) && (IS_CLKARDCLK_INVERTED <= 1'b1))) begin
      $display(
          "Attribute Syntax Error : The attribute IS_CLKARDCLK_INVERTED on RAMB18E1 instance %m is set to %b.  Legal values for this attribute are 1'b0 to 1'b1.",
    ...
    if (!((IS_CLKBWRCLK_INVERTED >= 1'b0) && (IS_CLKBWRCLK_INVERTED <= 1'b1))) begin
      $display(
          "Attribute Syntax Error : The attribute IS_CLKBWRCLK_INVERTED on RAMB18E1 instance %m is set to %b.  Legal values for this attribute are 1'b0 to 1'b1.",
    ...
    if (!((IS_ENARDEN_INVERTED >= 1'b0) && (IS_ENARDEN_INVERTED <= 1'b1))) begin
      $display(
          "Attribute Syntax Error : The attribute IS_ENARDEN_INVERTED on RAMB18E1 instance %m is set to %b.  Legal values for this attribute are 1'b0 to 1'b1.",
          IS_ENARDEN_INVERTED);
      attr_err = 1'b1;
    end
    ...
    if (!((IS_ENBWREN_INVERTED >= 1'b0) && (IS_ENBWREN_INVERTED <= 1'b1))) begin
      $display(
          "Attribute Syntax Error : The attribute IS_ENBWREN_INVERTED on RAMB18E1 instance %m is set to %b.  Legal values for this attribute are 1'b0 to 1'b1.",
          IS_ENBWREN_INVERTED);
      attr_err = 1'b1;
    end
    ...
    if (!((IS_RSTRAMARSTRAM_INVERTED >= 1'b0) && (IS_RSTRAMARSTRAM_INVERTED <= 1'b1))) begin
      $display(
          "Attribute Syntax Error : The attribute IS_RSTRAMARSTRAM_INVERTED on RAMB18E1 instance %m is set to %b.  Legal values for this attribute are 1'b0 to 1'b1.",
    ...
    if (!((IS_RSTRAMB_INVERTED >= 1'b0) && (IS_RSTRAMB_INVERTED <= 1'b1))) begin
      $display(
          "Attribute Syntax Error : The attribute IS_RSTRAMB_INVERTED on RAMB18E1 instance %m is set to %b.  Legal values for this attribute are 1'b0 to 1'b1.",
          IS_RSTRAMB_INVERTED);
      attr_err = 1'b1;
    end
    ...
    if (!((IS_RSTREGARSTREG_INVERTED >= 1'b0) && (IS_RSTREGARSTREG_INVERTED <= 1'b1))) begin
      $display(
          "Attribute Syntax Error : The attribute IS_RSTREGARSTREG_INVERTED on RAMB18E1 instance %m is set to %b.  Legal values for this attribute are 1'b0 to 1'b1.",
    ...
    if (!((IS_RSTREGB_INVERTED >= 1'b0) && (IS_RSTREGB_INVERTED <= 1'b1))) begin
      $display(
          "Attribute Syntax Error : The attribute IS_RSTREGB_INVERTED on RAMB18E1 instance %m is set to %b.  Legal values for this attribute are 1'b0 to 1'b1.",
          IS_RSTREGB_INVERTED);
      attr_err = 1'b1;
    end
  ...
  localparam [35:0] init_sdp = (READ_WIDTH_A == 36) ? {
    INIT_B[17:16], INIT_A[17:16], INIT_B[15:0], INIT_A[15:0]
  } : {
    INIT_B, INIT_A
  };
  localparam [35:0] srval_sdp = (READ_WIDTH_A == 36) ? {
...
module RB18_INTERNAL_VLOG (
  ...
  task task_ram_ox;
    ...
    begin
      ...
      if (ram_ox_we == 1'b1) begin
        ...
        if (width >= 8) ram_ox_memp_task = ram_ox_dip;
  ...
  task chk_for_col_msg;
    ...
    begin
      ...
      if (SIM_COLLISION_CHECK == "ALL" || SIM_COLLISION_CHECK == "WARNING_ONLY")
        ...
        end else if (wea_tmp === 1'b0 && web_tmp === 1'b1 && col_wrb_rda_msg == 1) begin
    ...
    begin
      ...
      if (|do_tmp === 1'bx) begin  // if there is collision
        ...
        if (task_syndrome !== 0) begin
          ...
          end else if (!task_syndrome[7]) begin  // double bit error
            sbiterr_out <= 0;
            dbiterr_out <= 1;
  ...
  initial begin
    ...
    case (EN_ECC_WRITE)
      ...
      default: begin
        $display(
            "Attribute Syntax Error : The attribute EN_ECC_WRITE on RAMB18E1 instance %m is set to %s.  Legal values for this attribute are TRUE or FALSE.",
            EN_ECC_WRITE);
        finish_error = 1;
      end
    endcase
    ...
    case (EN_ECC_READ)
      ...
      default: begin
        $display(
            "Attribute Syntax Error : The attribute EN_ECC_READ on RAMB18E1 instance %m is set to %s.  Legal values for this attribute are TRUE or FALSE.",
            EN_ECC_READ);
        finish_error = 1;
      end
    endcase
    ...
    case (RAM_MODE)
      "TDP": begin
        ...
        if (en_ecc_write_int == 1) begin
          $display(
              "DRC Error : The attribute EN_ECC_WRITE on RAMB18E1 instance %m is set to %s which requires RAM_MODE = SDP.",
              EN_ECC_WRITE);
          finish_error = 1;
        end
        ...
        if (en_ecc_read_int == 1) begin
          $display(
              "DRC Error : The attribute EN_ECC_READ on RAMB18E1 instance %m is set to %s which requires RAM_MODE = SDP.",
              EN_ECC_READ);
          finish_error = 1;
        end
      ...
      "SDP": begin
        ...
        if ((WRITE_MODE_A != WRITE_MODE_B) || WRITE_MODE_A == "NO_CHANGE" || WRITE_MODE_B == "NO_CHANGE") begin
          ...
          $display(
              "DRC Error : Both attributes WRITE_MODE_A and WRITE_MODE_B must be set to READ_FIRST or both attributes must be set to WRITE_FIRST when RAM_MODE = SDP on RAMB18E1 instance %m.");
      ...
      default: begin
        $display(
            "Attribute Syntax Error : The attribute RAM_MODE on RAMB18E1 instance %m is set to %s.  Legal values for this attribute are TDP or SDP.",
            RAM_MODE);
        finish_error = 1;
      end
    endcase
    ...
    case (WRITE_WIDTH_A)
      ...
      36: begin
        if (BRAM_SIZE == 18 && ram_mode_int == 1) begin
          $display(
              "Attribute Syntax Error : The attribute WRITE_WIDTH_A on RAMB18E1 instance %m is set to %d.  Legal values for this attribute are 0, 1, 2, 4, 9 or 18.",
              WRITE_WIDTH_A);
          finish_error = 1;
        end
      end
      72: begin
        if (BRAM_SIZE == 18) begin
          ...
          $display(
              "Attribute Syntax Error : The attribute WRITE_WIDTH_A on RAMB18E1 instance %m is set to %d.  Legal values for this attribute are 0, 1, 2, 4, 9, 18 or 36.",
              WRITE_WIDTH_A);
          finish_error = 1;
        end
      end
    ...
    case (WRITE_WIDTH_B)
      ...
      36: begin
        if (BRAM_SIZE == 18 && ram_mode_int == 1) begin
          $display(
              "Attribute Syntax Error : The attribute WRITE_WIDTH_B on RAMB18E1 instance %m is set to %d.  Legal values for this attribute are 0, 1, 2, 4, 9 or 18.",
              WRITE_WIDTH_B);
          finish_error = 1;
        end
      end
      72: begin
        if (BRAM_SIZE == 18) begin
          ...
          $display(
              "Attribute Syntax Error : The attribute WRITE_WIDTH_B on RAMB18E1 instance %m is set to %d.  Legal values for this attribute are 0, 1, 2, 4, 9, 18 or 36.",
              WRITE_WIDTH_B);
          finish_error = 1;
        end
      end
    ...
    case (READ_WIDTH_A)
      ...
      36: begin
        if (BRAM_SIZE == 18 && ram_mode_int == 1) begin
          $display(
              "Attribute Syntax Error : The attribute READ_WIDTH_A on RAMB18E1 instance %m is set to %d.  Legal values for this attribute are 0, 1, 2, 4, 9 or 18.",
              READ_WIDTH_A);
          finish_error = 1;
        end
      end
      72: begin
        if (BRAM_SIZE == 18) begin
          ...
          $display(
              "Attribute Syntax Error : The attribute READ_WIDTH_A on RAMB18E1 instance %m is set to %d.  Legal values for this attribute are 0, 1, 2, 4, 9, 18 or 36.",
              READ_WIDTH_A);
          finish_error = 1;
        end
      end
    ...
    case (READ_WIDTH_B)
      ...
      36: begin
        if (BRAM_SIZE == 18 && ram_mode_int == 1) begin
          $display(
              "Attribute Syntax Error : The attribute READ_WIDTH_B on RAMB18E1 instance %m is set to %d.  Legal values for this attribute are 0, 1, 2, 4, 9 or 18.",
              READ_WIDTH_B);
          finish_error = 1;
        end
      end
      72: begin
        if (BRAM_SIZE == 18) begin
          ...
          $display(
              "Attribute Syntax Error : The attribute READ_WIDTH_B on RAMB18E1 instance %m is set to %d.  Legal values for this attribute are 0, 1, 2, 4, 9, 18 or 36.",
              READ_WIDTH_B);
          finish_error = 1;
        end
      end
    ...
    if ((RAM_EXTENSION_A == "LOWER" || RAM_EXTENSION_A == "UPPER") && READ_WIDTH_A != 1) begin
      $display(
          "Attribute Syntax Error : If attribute RAM_EXTENSION_A on RAMB18E1 instance %m is set to either LOWER or UPPER, then READ_WIDTH_A has to be set to 1.");
      finish_error = 1;
    end
    ...
    if ((RAM_EXTENSION_A == "LOWER" || RAM_EXTENSION_A == "UPPER") && WRITE_WIDTH_A != 1) begin
      $display(
          "Attribute Syntax Error : If attribute RAM_EXTENSION_A on RAMB18E1 instance %m is set to either LOWER or UPPER, then WRITE_WIDTH_A has to be set to 1.");
      finish_error = 1;
    end
    ...
    if ((RAM_EXTENSION_B == "LOWER" || RAM_EXTENSION_B == "UPPER") && READ_WIDTH_B != 1) begin
      $display(
          "Attribute Syntax Error : If attribute RAM_EXTENSION_B on RAMB18E1 instance %m is set to either LOWER or UPPER, then READ_WIDTH_B has to be set to 1.");
      finish_error = 1;
    end
    ...
    if ((RAM_EXTENSION_B == "LOWER" || RAM_EXTENSION_B == "UPPER") && WRITE_WIDTH_B != 1) begin
      $display(
          "Attribute Syntax Error : If attribute RAM_EXTENSION_B on RAMB18E1 instance %m is set to either LOWER or UPPER, then WRITE_WIDTH_B has to be set to 1.");
      finish_error = 1;
    end
    ...
    if (READ_WIDTH_A == 0 && READ_WIDTH_B == 0) begin
      $display(
          "Attribute Syntax Error : Attributes READ_WIDTH_A and READ_WIDTH_B on RAMB18E1 instance %m, both can not be 0.");
      finish_error = 1;
    end
    ...
    case (WRITE_MODE_A)
      ...
      default: begin
        $display(
            "Attribute Syntax Error : The Attribute WRITE_MODE_A on RAMB18E1 instance %m is set to %s.  Legal values for this attribute are WRITE_FIRST, READ_FIRST or NO_CHANGE.",
            WRITE_MODE_A);
        finish_error = 1;
      end
    endcase
    ...
    case (WRITE_MODE_B)
      ...
      default: begin
        $display(
            "Attribute Syntax Error : The Attribute WRITE_MODE_B on RAMB18E1 instance %m is set to %s.  Legal values for this attribute are WRITE_FIRST, READ_FIRST or NO_CHANGE.",
            WRITE_MODE_B);
        finish_error = 1;
      end
    endcase
    ...
    case (RAM_EXTENSION_A)
      ...
      default: begin
        $display(
            "Attribute Syntax Error : The attribute RAM_EXTENSION_A on RAMB18E1 instance %m is set to %s.  Legal values for this attribute are LOWER, NONE or UPPER.",
            RAM_EXTENSION_A);
        finish_error = 1;
      end
    endcase
    ...
    case (RAM_EXTENSION_B)
      ...
      default: begin
        $display(
            "Attribute Syntax Error : The attribute RAM_EXTENSION_B on RAMB18E1 instance %m is set to %s.  Legal values for this attribute are LOWER, NONE or UPPER.",
            RAM_EXTENSION_B);
        finish_error = 1;
      end
    endcase
    ...
    if ((SIM_COLLISION_CHECK != "ALL") && (SIM_COLLISION_CHECK != "NONE") && (SIM_COLLISION_CHECK != "WARNING_ONLY") && (SIM_COLLISION_CHECK != "GENERATE_X_ONLY")) begin
      ...
      $display(
          "Attribute Syntax Error : The attribute SIM_COLLISION_CHECK on RAMB18E1 instance %m is set to %s.  Legal values for this attribute are ALL, NONE, WARNING_ONLY or GENERATE_X_ONLY.",
          SIM_COLLISION_CHECK);
      finish_error = 1;
    ...
    case (RSTREG_PRIORITY_A)
      ...
      default: begin
        $display(
            "Attribute Syntax Error : The attribute RSTREG_PRIORITY_A on RAMB18E1 instance %m is set to %s.  Legal values for this attribute are RSTREG or REGCE.",
            RSTREG_PRIORITY_A);
        finish_error = 1;
      end
    endcase
    ...
    case (RSTREG_PRIORITY_B)
      ...
      default: begin
        $display(
            "Attribute Syntax Error : The attribute RSTREG_PRIORITY_B on RAMB18E1 instance %m is set to %s.  Legal values for this attribute are RSTREG or REGCE.",
            RSTREG_PRIORITY_B);
        finish_error = 1;
      end
    endcase
    ...
    if ((en_ecc_write_int == 1 || en_ecc_read_int == 1) && (WRITE_WIDTH_B != 72 || READ_WIDTH_A != 72)) begin
      $display(
          "DRC Error : Attributes WRITE_WIDTH_B and READ_WIDTH_A have to be set to 72 on RAMB18E1 instance %m when either attribute EN_ECC_WRITE or EN_ECC_READ is set to TRUE.");
      finish_error = 1;
    end
    ...
    case (RDADDR_COLLISION_HWCONFIG)
      ...
      default: begin
        $display(
            "Attribute Syntax Error : The attribute RDADDR_COLLISION_HWCONFIG on RAMB18E1 instance %m is set to %s.  Legal values for this attribute are DELAYED_WRITE or PERFORMANCE.",
    ...
    if (!(SIM_DEVICE == "VIRTEX6" || SIM_DEVICE == "7SERIES")) begin
      $display(
          "Attribute Syntax Error : The Attribute SIM_DEVICE on RAMB18E1 instance %m is set to %s.  Legal values for this attribute are VIRTEX6, or 7SERIES.",
          SIM_DEVICE);
      finish_error = 1;
    end


    if (finish_error == 1) #1 $finish;
  ...
  always @(time_clka_period or time_clkb_period) begin
    ...
    if (time_clka_period != 0 && time_clkb_period != 0) begin
      ...
      end else if (time_clkb_period <= SETUP_READ_FIRST) time_period = time_clkb_period;
      else time_period = SETUP_READ_FIRST;
  ...
  always @(posedge rising_clka or posedge rising_clkb) begin
    ...
    if ((cascade_a == 2'b00 || (addra_in_15_reg_bram == 1'b0 && cascade_a != 2'b00)) && (cascade_b == 2'b00 || (addrb_in_15_reg_bram == 1'b0 && cascade_b != 2'b00)))  begin
      ...
      if (SIM_COLLISION_CHECK != "NONE") begin
        ...
        if (GSR === 1'b0) begin
          ...
          if (time_port_a > time_port_b) begin
            ...
            if (time_port_a - time_port_b <= sync_clk_skew) begin
              viol_time = 1;
            end else if (time_port_a - time_port_b <= time_period) begin
              viol_time = 2;
            end
          end else begin
            ...
            if (time_port_b - time_port_a <= sync_clk_skew) begin
              viol_time = 1;
            end else if (time_port_b - time_port_a <= time_period) begin
              viol_time = 2;
            end
          ...
          if (ENA === 1'b0 || ENB === 1'b0) viol_time = 0;
              ...
              if ((rising_clka && rising_clkb) || viol_time == 1) begin
                ...
                if (ADDRA[15:col_addr_lsb] === ADDRB[15:col_addr_lsb]) begin
                  ...
                  if (en_ecc_write_int == 1 || en_ecc_read_int == 1) begin
                    ...
                    end else if (injectsbiterr_in === 1) begin
                      dib_ecc_col[30] = ~dib_ecc_col[30];
                    end
                  ...
                  end else task_col_wr_ram_b(2'b10, WEA, WEB, dib_ecc_col, DIPB, ADDRA, ADDRB);
                  ...
                  if (time_port_a > time_port_b) task_rd_ram_a(ADDRA, doa_buf, dopa_buf);
                  else if (time_port_b > time_port_a) task_rd_ram_b(ADDRB, dob_buf, dopb_buf);
                  else begin
                    task_rd_ram_a(ADDRA, doa_buf, dopa_buf);
                    task_rd_ram_b(ADDRB, dob_buf, dopb_buf);
                  end
                  ...
                  end else task_ox_wr_ram_b(2'b10, WEA, WEB, dib_ecc_col, DIPB, ADDRA, ADDRB);
        ...
        if (SIM_COLLISION_CHECK == "WARNING_ONLY") viol_time = 0;
    ...
    if (rising_clka) begin
      ...
      if (RSTRAMA === 1 && ram_mode_int == 0 && (en_ecc_write_int == 1 || en_ecc_read_int == 1))
        $display(
            "DRC Warning : SET/RESET (RSTRAM) is not supported in ECC mode on RAMB18E1 instance %m.");

      // end DRC


      // registering ADDRA[15] the second time
      if (REGCEA) addra_in_15_reg1 = addra_in_15_reg;
          ...
          if (wr_mode_a == 2'b01 || (ram_mode_int == 0 && en_ecc_read_int == 1)) begin
            ...
            if (ram_mode_int == 0 && en_ecc_read_int == 1) begin
              ...
              if (syndrome !== 0) begin
                ...
                end else if (!syndrome[7]) begin  // double bit error
                  sbiterr_out <= 0;
                  dbiterr_out <= 1;
    ...
    if (rising_clkb) begin
      ...
      if (!(en_ecc_write_int == 1 || en_ecc_read_int == 1)) begin
        ...
        if (injectsbiterr_in === 1)
          $display(
              "DRC Warning : INJECTSBITERR is not supported when neither EN_ECC_WRITE nor EN_ECC_READ = TRUE on RAMB18E1 instance %m.");

        if (injectdbiterr_in === 1)
          $display(
              "DRC Warning : INJECTDBITERR is not supported when neither EN_ECC_WRITE nor EN_ECC_READ = TRUE on RAMB18E1 instance %m.");

      end
      // End DRC


      if (REGCEB) addrb_in_15_reg1 = addrb_in_15_reg;
      ...
      if (GSR == 1'b0 && ENB == 1'b1 && (cascade_b == 2'b00 || (addrb_in_15_reg_bram == 1'b0 && cascade_b != 2'b00))) begin
        ...
        if (viol_time == 0) begin
          ...
          if (en_ecc_write_int == 1 || en_ecc_read_int == 1) begin
            ...
            end else if (injectsbiterr_in === 1) begin  // single bit
              dib_in_ecc[30] = ~dib_in_ecc[30];
            end
          ...
          // Read first
          if (wr_mode_b == 2'b01 && RSTRAMB === 1'b0) task_rd_ram_b(ADDRB, dob_buf, dopb_buf);
    ...
    if (GSR == 1'b0) begin
      ...
      if (ENA && (rising_clka || viol_time != 0)) begin
        ...
        if (RSTRAMA === 1'b0 && (wr_mode_a != 2'b10 || (WRITE_WIDTH_A <= 9 && WEA[0] === 1'b0) || (WRITE_WIDTH_A == 18 && WEA[1:0] === 2'b00) || ((WRITE_WIDTH_A == 36 || WRITE_WIDTH_A == 72) && WEA[3:0] === 4'b0000))) begin
          ...
          if (ra_width >= 8) dopa_out <= dopa_buf;
      ...
      if (ENB && (rising_clkb || viol_time != 0)) begin
        ...
        if (RSTRAMB === 1'b0 && (wr_mode_b != 2'b10 || (WRITE_WIDTH_B <= 9 && WEB[0] === 1'b0) || (WRITE_WIDTH_B == 18 && WEB[1:0] === 2'b00) || (WRITE_WIDTH_B == 36 && WEB[3:0] === 4'b0000) || (WRITE_WIDTH_B == 72 && WEB[7:0] === 8'h00))) begin
          ...
          if (rb_width >= 8) dopb_out <= dopb_buf;
...
`endif
  ...
  always @(posedge CLKA or CASCADEINA or addra_in_15_reg or doa_out or dopa_out) begin
    ...
    if (cascade_a[1] == 1'b1 && addra_in_15_reg == 1'b1) begin
      ...
      if (ra_width >= 8) dopa_out_mux = dopa_out;
  ...
  always @(posedge CLKA or CASCADEINA or addra_in_15_reg1 or doa_outreg or dopa_outreg) begin
    ...
    if (cascade_a[1] == 1'b1 && addra_in_15_reg1 == 1'b1) begin
      ...
      if (ra_width >= 8) dopa_outreg_mux = dopa_outreg;
  ...
  always @(posedge CLKB or CASCADEINB or addrb_in_15_reg or dob_out or dopb_out) begin
    ...
    if (cascade_b[1] == 1'b1 && addrb_in_15_reg == 1'b1) begin
      ...
      if (rb_width >= 8) dopb_out_mux = dopb_out;
  ...
  always @(posedge CLKB or CASCADEINB or addrb_in_15_reg1 or dob_outreg or dopb_outreg) begin
    ...
    if (cascade_b[1] == 1'b1 && addrb_in_15_reg1 == 1'b1) begin
      ...
      if (rb_width >= 8) dopb_outreg_mux = dopb_outreg;
  ...
  always @(posedge CLKA or posedge GSR) begin
    ...
    if (DOA_REG == 1) begin
      ...
      if (GSR == 1'b1) begin
        ...
        if (ra_width >= 8) dopa_outreg <= INIT_A[ra_width +: ra_widthp];
        ...
        if (rstreg_priority_a_int == 0) begin  // Virtex5 behavior
          ...
          if (REGCEA == 1'b1) begin
            if (RSTREGA == 1'b1) begin
              ...
              if (ra_width >= 8) dopa_outreg <= SRVAL_A[ra_width +: ra_widthp];

            end else if (RSTREGA == 1'b0) begin

              doa_outreg <= doa_out;

              if (ra_width >= 8) dopa_outreg <= dopa_out;
  ...
  always @(temp_wire or doa_out_mux or dopa_out_mux or doa_outreg_mux or dopa_outreg_mux or dbiterr_out or dbiterr_outreg or sbiterr_out or sbiterr_outreg or rdaddrecc_out or rdaddrecc_outreg) begin
    ...
    case (DOA_REG)
      ...
      0: begin
        ...
        if (ra_width >= 8) DOPA[0 +: ra_widthp] = dopa_out_mux[0 +: ra_widthp];
      ...
      1: begin
        ...
        if (ra_width >= 8) DOPA[0 +: ra_widthp] = dopa_outreg_mux[0 +: ra_widthp];

      end
      default: begin
        $display(
            "Attribute Syntax Error : The attribute DOA_REG on RAMB18E1 instance %m is set to %2d.  Legal values for this attribute are 0 or 1.",
            DOA_REG);
        $finish;
      end
  ...
  always @(posedge CLKB or posedge GSR) begin
    ...
    if (DOB_REG == 1) begin
      ...
      if (GSR == 1'b1) begin
        ...
        if (rb_width >= 8) dopb_outreg <= INIT_B[rb_width +: rb_widthp];
        ...
        if (rstreg_priority_b_int == 0) begin  // Virtex5 behavior
          ...
          if (REGCEB == 1'b1) begin
            if (RSTREGB == 1'b1) begin
              ...
              if (rb_width >= 8) dopb_outreg <= SRVAL_B[rb_width +: rb_widthp];

            end else if (RSTREGB == 1'b0) begin

              dob_outreg <= dob_out;

              if (rb_width >= 8) dopb_outreg <= dopb_out;
  ...
  always @(temp_wire or dob_out_mux or dopb_out_mux or dob_outreg_mux or dopb_outreg_mux) begin
    ...
    case (DOB_REG)
      ...
      0: begin
        ...
        if (rb_width >= 8) DOPB[0 +: rb_widthp] = dopb_out_mux[0 +: rb_widthp];
      end
      1: begin
        DOB[0 +: rb_width] = dob_outreg_mux[0 +: rb_width];

        if (rb_width >= 8) DOPB[0 +: rb_widthp] = dopb_outreg_mux[0 +: rb_widthp];

      end
      default: begin
        $display(
            "Attribute Syntax Error : The attribute DOB_REG on RAMB18E1 instance %m is set to %2d.  Legal values for this attribute are 0 or 1.",
            DOB_REG);
        $finish;
      end
