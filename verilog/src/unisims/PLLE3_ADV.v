...
`endif
  ...
  always @(trig_attr) begin
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display(
          "Error: [Unisim %s-140] COMPENSATION attribute is set to %s.  Legal values for this attribute are AUTO, BUF_IN or INTERNAL. Instance: %m",
    ...
    if ((attr_test == 1'b1) ||
      ...
      $display(
          "Error: [Unisim %s-156] VCOCLK_FREQ_MAX attribute is set to %f.  Legal values for this attribute are 1200.000 to 1335.000. Instance: %m",
