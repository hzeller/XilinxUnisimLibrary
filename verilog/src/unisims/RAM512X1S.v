...
`ifdef XIL_TIMING
  ...
  specify
    ...
    $setuphold (negedge WCLK, negedge A[8], 0:0:0, 0:0:0, notifier,sh_we_clk_en_n,sh_we_clk_en_n,WCLK_dly,A_dly[8]);
    ...
    $setuphold (negedge WCLK, posedge A[8], 0:0:0, 0:0:0, notifier,sh_we_clk_en_n,sh_we_clk_en_n,WCLK_dly,A_dly[8]);
    ...
    $setuphold (posedge WCLK, negedge A[8], 0:0:0, 0:0:0, notifier,sh_we_clk_en_p,sh_we_clk_en_p,WCLK_dly,A_dly[8]);
    ...
    $setuphold (posedge WCLK, posedge A[8], 0:0:0, 0:0:0, notifier,sh_we_clk_en_p,sh_we_clk_en_p,WCLK_dly,A_dly[8]);
