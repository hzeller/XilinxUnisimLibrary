...
`endif
  ...
  initial begin
    case (CE_TYPE)
      ...
      default: begin
        $display(
            "Attribute Syntax Error : The Attribute CE_TYPE on BUFHCE instance %m is set to %s.  Legal values for this attribute are SYNC, or ASYNC."
                , CE_TYPE);
        #1 $finish;
      end
    endcase
    ...
    if ((INIT_OUT >= 0) && (INIT_OUT <= 1)) INIT_OUT_BINARY = INIT_OUT;
      ...
      $display(
          "Attribute Syntax Error : The Attribute INIT_OUT on BUFHCE instance %m is set to %d.  Legal values for this attribute are  0 to 1."
              , INIT_OUT);
      #1 $finish;
    end
  ...
  defparam bufgctrl0_inst.INIT_OUT = 1'b0; defparam bufgctrl0_inst.PRESELECT_I0 = "TRUE";
  ...
  defparam bufgctrl1_inst.INIT_OUT = 1'b0; defparam bufgctrl1_inst.PRESELECT_I0 = "TRUE";
