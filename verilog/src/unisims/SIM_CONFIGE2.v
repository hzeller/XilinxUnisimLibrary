...
`endif
  ...
  assign (weak1, strong0) DONE = (done_o[0] !== 1'b0) && ((bout_en[1] == 0) || (done_o[1] !== 1'b0))
      && ((bout_en[2] == 0) || (done_o[2] !== 1'b0)) && ((bout_en[3] == 0) || (done_o[3] !== 1'b0));
  //
  ...
  assign i_init_b_cmd_t = i_init_b_cmd_0 & i_init_b_cmd_1 & i_init_b_cmd_2 & i_init_b_cmd_3;
  ...
  always @(init_b_t or prog_b_t)
    if (prog_b_t == 0) mode_sample_flag <= 0;
  ...
  always @(posedge cclk_in or negedge rst_intl)
    if (rst_intl == 0) begin
      ...
      buswidth_tmp[2] <= 2'b00;
      buswidth_tmp[3] <= 2'b00;
    end else if (buswid_flag[ib] == 0) begin
  ...
  always @(buswidth_ibtmp) buswidth[ib] = buswidth_ibtmp;
  ...
  always @(posedge eos_startup[0])
    if (icap_on == 1) begin
      ...
      icap_init_done <= 1;
      @(posedge cclk_in);
      @(posedge cclk_in) if (icap_init_done_dly == 0) icap_desynch <= 1;
      @(posedge cclk_in);
  ...
  always @(posedge cclk_in or negedge rdwr_b_in)
    if (rdwr_b_in == 0) rd_sw_en <= 0;
    else begin
      if (csi_b_in == 1 && rdwr_b_in == 1) rd_sw_en <= 1;
    end
    ...
    if (icap_init_done == 1 && csi_b_in == 1 && rdwr_b_in == 0) begin
      ...
      if (icap_clr == 1) begin
        ...
        if (rdwr_b_in == 0) begin
          ...
          if (buswidth[ib] == 2'b01 || (icap_sync == 1 && bus_sync_flag[ib] == 0)) begin
            ...
            if (bus_sync_flag[ib] == 0) begin
              ...
              if (wr_cnt[ib] == 0) begin
                ...
                new_data_in_flag[ib] <= 0;
                wr_cnt[ib] <= 1;
              end else if (wr_cnt[ib] == 1) begin
                pack_in_reg_tmp0 = pack_in_reg[ib];
                pack_in_reg_tmp0[23:16] = tmp_byte;
                pack_in_reg_tmps0 <= pack_in_reg_tmp0;
                new_data_in_flag[ib] <= 0;
                wr_cnt[ib] <= 2;
              end else if (wr_cnt[ib] == 2) begin
                pack_in_reg_tmp0 = pack_in_reg[ib];
                pack_in_reg_tmp0[15:8] = tmp_byte;
                pack_in_reg_tmps0 <= pack_in_reg_tmp0;
                new_data_in_flag[ib] <= 0;
                wr_cnt[ib] <= 3;
              end else if (wr_cnt[ib] == 3) begin
                pack_in_reg_tmp0 = pack_in_reg[ib];
                pack_in_reg_tmp0[7:0] = tmp_byte;
                pack_in_reg_tmps0 <= pack_in_reg_tmp0;
          ...
          end else if (buswidth[ib] == 2'b10) begin
            ...
            tmp_dword = {bit_revers8(d_in[31:24]), bit_revers8(d_in[23:16]),
                         bit_revers8(d_in[15:8]), bit_revers8(d_in[7:0])};
  ...
  always @(pack_in_reg_tmps0 or desync_flag or icap_clr) begin
    if (desync_flag[0] == 1 || icap_clr == 1) pack_in_reg[0] = 32'b0;
    if (desync_flag[1] == 1 || icap_clr == 1) pack_in_reg[1] = 32'b0;
    if (desync_flag[2] == 1 || icap_clr == 1) pack_in_reg[2] = 32'b0;
    if (desync_flag[3] == 1 || icap_clr == 1) pack_in_reg[3] = 32'b0;
  ...
  always @(negedge cclk_in or negedge rst_intl)
    if (rst_intl == 0) begin
      ...
      if (new_data_in_flag[ib] == 1 && wr_flag[ib] == 1 && csi_b_ins == 0 &&
        ...
        if (conti_data_flag[ib] == 1) begin
          ...
          if (conti_data_cnt[ib] <= 1) begin
            conti_data_cnt[ib] <= 0;
          end else conti_data_cnt[ib] <= conti_data_cnt[ib] - 1;
        end else if (conti_data_flag[ib] == 0) begin
          ...
          if (pack_in_reg_tmp[31:29] == 3'b010) begin
            ...
            if (reg_addr[ib] == 5'b00010 && downcont_cnt == 0) begin
              ...
              far_addr <= far_reg[ib];
            end else if (reg_addr_tmp == 5'b11110 && bout_cnt_tmp == 0) begin
              cmd_rd_flag[ib] <= 0;
              cmd_wr_flag[ib] <= 0;
              conti_data_flag[ib] <= 0;
              conti_data_cnt[ib] <= 0;
            ...
            end else if (reg_addr[ib] == 5'b01000 && csbo_cnt[ib] == 0) begin
              cmd_rd_flag[ib] <= 0;
              cmd_wr_flag[ib] <= 0;
              conti_data_flag[ib] <= 0;
              conti_data_cnt[ib] <= 0;
          ...
          end else if (pack_in_reg_tmp[31:29] == 3'b001) begin  // type 1 package
            ...
            end else if (pack_in_reg_tmp[28:27] == 2'b10 && downcont_cnt == 0) begin
        ...
        if (csbo_cnt[ib] != 0) begin
          if (csbo_flag[ib] == 1) csbo_cnt[ib] <= csbo_cnt[ib] - 1;
        end else csbo_flag[ib] <= 0;
        ...
        if (conti_data_cnt[ib] == 5'b00001) conti_data_flag[ib] <= 0;

        if (crc_ck[ib] == 1 || icap_init_done == 1) crc_ck[ib] <= 0;
      end
      ...
      if (rw_en[ib] == 1 && csi_b_ins == 0) begin
        ...
        if (downcont_cnt >= 1 && conti_data_flag[ib] == 0 && new_data_in_flag[ib] == 1 &&
            wr_flag[ib] == 1)
          downcont_cnt <= downcont_cnt - 1;
      end


      if (cmd_reg_new_flag[ib] == 1) cmd_reg_new_flag[ib] <= 0;
  ...
  always @(bout_flag)
    if (bout_flag[3] == 1) begin
      ib = 3;
      ib_skp = 1;
    end else if (bout_flag[2] == 1) begin
      ib = 3;
      ib_skp = 0;
    end else if (bout_flag[1] == 1) begin
      ib = 2;
      ib_skp = 0;
    end else if (bout_flag[0] == 1) begin
      ib = 1;
      ib_skp = 0;
    end else begin
      ib = 0;
  ...
  always @(posedge startup_set[0] or posedge desynch_set[0] or posedge rw_en[0])
    if (rw_en[0] == 1 || desynch_set[0] == 1) begin
      if (startup_set_pulse0 == 2'b00 && startup_set[0] == 1) begin
        if (icap_on == 0) startup_set_pulse0 <= 2'b01;
        else begin
          startup_set_pulse0 <= 2'b11;
          @(posedge cclk_in) startup_set_pulse0 <= 2'b00;
        end
      end else if (desynch_set[0] == 1 && startup_set_pulse0 == 2'b01) begin
        startup_set_pulse0 <= 2'b11;
        @(posedge cclk_in) startup_set_pulse0 <= 2'b00;
      end
    end
  ...
  always @(posedge startup_set[1] or posedge desynch_set[1] or posedge rw_en[1])
    if (rw_en[1] == 1 || desynch_set[1] == 1) begin
      if (startup_set_pulse1 == 2'b00 && startup_set[1] == 1) begin
        if (icap_on == 0) startup_set_pulse1 <= 2'b01;
        else begin
          startup_set_pulse1 <= 2'b11;
          @(posedge cclk_in) startup_set_pulse1 <= 2'b00;
        end
      end else if (desynch_set[1] == 1 && startup_set_pulse1 == 2'b01) begin
        startup_set_pulse1 <= 2'b11;
        @(posedge cclk_in) startup_set_pulse1 <= 2'b00;
      end
    end
  ...
  always @(posedge startup_set[2] or posedge desynch_set[2] or posedge rw_en[2])
    if (rw_en[2] == 1 || desynch_set[2] == 1) begin
      if (startup_set_pulse2 == 2'b00 && startup_set[2] == 1) begin
        if (icap_on == 0) startup_set_pulse2 <= 2'b01;
        else begin
          startup_set_pulse2 <= 2'b11;
          @(posedge cclk_in) startup_set_pulse2 <= 2'b00;
        end
      end else if (desynch_set[2] == 1 && startup_set_pulse2 == 2'b01) begin
        startup_set_pulse2 <= 2'b11;
        @(posedge cclk_in) startup_set_pulse2 <= 2'b00;
      end
    end
  ...
  always @(posedge startup_set[3] or posedge desynch_set[3] or posedge rw_en[3])
    if (rw_en[3] == 1 || desynch_set[3] == 1) begin
      if (startup_set_pulse3 == 2'b00 && startup_set[3] == 1) begin
        if (icap_on == 0) startup_set_pulse3 <= 2'b01;
        else begin
          startup_set_pulse3 <= 2'b11;
          @(posedge cclk_in) startup_set_pulse3 <= 2'b00;
        end
      end else if (desynch_set[3] == 1 && startup_set_pulse3 == 2'b01) begin
        startup_set_pulse3 <= 2'b11;
        @(posedge cclk_in) startup_set_pulse3 <= 2'b00;
      end
    end
  ...
  always @(posedge gsr_cmd_out[0] or negedge rw_en[0])
    if (rw_en[0] == 0) gsr_cmd_out_pulse[0] <= 0;
    else begin
      gsr_cmd_out_pulse[0] <= 1;
      @(posedge cclk_in);
      @(posedge cclk_in) gsr_cmd_out_pulse[0] <= 0;
    end

  always @(posedge gsr_cmd_out[1] or negedge rw_en[1])
    if (rw_en[1] == 0) gsr_cmd_out_pulse[1] <= 0;
    else begin
      gsr_cmd_out_pulse[1] <= 1;
      @(posedge cclk_in);
      @(posedge cclk_in) gsr_cmd_out_pulse[1] <= 0;
    end

  always @(posedge gsr_cmd_out[2] or negedge rw_en[2])
    if (rw_en[2] == 0) gsr_cmd_out_pulse[2] <= 0;
    else begin
      gsr_cmd_out_pulse[2] <= 1;
      @(posedge cclk_in);
      @(posedge cclk_in) gsr_cmd_out_pulse[2] <= 0;
    end

  always @(posedge gsr_cmd_out[3] or negedge rw_en[3])
    if (rw_en[3] == 0) gsr_cmd_out_pulse[3] <= 0;
    else begin
      gsr_cmd_out_pulse[3] <= 1;
      @(posedge cclk_in);
      @(posedge cclk_in) gsr_cmd_out_pulse[3] <= 0;
    end
  ...
  task cur_st_tsk;
    ...
    begin
      if (nst_in == STARTUP_PH1) begin
        stup_bflag = 1;
        stup_eflag = 0;
      end else if (cst_in == STARTUP_PH7) begin
        stup_eflag = 1;
        stup_bflag = 0;
      end
      if ((lock_cycle_in == 3'b111) || (pll_locked == 1) || (
          pll_locked == 0 && cst_in != lock_cycle_in)) begin
        cst_o = nst_in;
      end else cst_o = cst_in;
    end
  endtask
  ...
  task nx_st_tsk;
    ...
    begin
      if (((cur_st == done_cycle_in) && (DONE !== 0)) || (cur_st != done_cycle_in))
        case (cur_st)
          STARTUP_PH0:
          if (stup_pulse == 2'b11) nx_st = STARTUP_PH1;
  ...
  always @(posedge cclk_in or negedge rst_intl)
    if (rst_intl == 0) begin
      ...
      if (st_state1 == gwe_cycle_reg1) gwe_out[1] <= 1;
      if (st_state2 == gwe_cycle_reg2) gwe_out[2] <= 1;
      if (st_state3 == gwe_cycle_reg3) gwe_out[3] <= 1;

      if (st_state0 == gts_cycle_reg0) gts_out[0] <= 0;
      if (st_state1 == gts_cycle_reg1) gts_out[1] <= 0;
      if (st_state2 == gts_cycle_reg2) gts_out[2] <= 0;
      if (st_state3 == gts_cycle_reg3) gts_out[3] <= 0;

      if (st_state0 == STARTUP_PH6) gsr_st_out[0] <= 0;
      if (st_state1 == STARTUP_PH6) gsr_st_out[1] <= 0;
      if (st_state2 == STARTUP_PH6) gsr_st_out[2] <= 0;
      if (st_state3 == STARTUP_PH6) gsr_st_out[3] <= 0;

      if (st_state0 == STARTUP_PH7) eos_startup[0] <= 1;
      if (st_state1 == STARTUP_PH7) eos_startup[1] <= 1;
      if (st_state2 == STARTUP_PH7) eos_startup[2] <= 1;
  ...
  always @(posedge cclk_in or negedge rst_intl or posedge abort_flag_rst or posedge csi_b_in)
  ...
  always @(posedge abort_flag[ib]) begin
    ...
    @(posedge cclk_in) abort_status <= {cfgerr_b_flag[ib], 1'b1, 1'b0, 1'b0, 4'b1111};
