...
`endif
  ...
  initial begin
    ...
    case (EN_ISERDES_RST)
      ...
      default: begin
        $display(
            "Attribute Syntax Error : The Attribute EN_ISERDES_RST on %s instance %m is set to %s.  Legal values for this attribute are FALSE or TRUE.",
            MODULE_NAME, EN_ISERDES_RST);
        #1 $finish;
      end
    endcase
