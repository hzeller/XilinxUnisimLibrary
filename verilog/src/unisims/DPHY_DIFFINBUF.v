...
`endif
  ...
  assign DIFF_TERM_BIN = (DIFF_TERM_REG == "FALSE") ?
      DIFF_TERM_FALSE : (DIFF_TERM_REG == "TRUE") ? DIFF_TERM_TRUE : DIFF_TERM_TRUE;

  assign ISTANDARD_BIN = (ISTANDARD_REG == "DEFAULT") ? ISTANDARD_DEFAULT : ISTANDARD_DEFAULT;
...
`endif
  ...
  assign HSRX_O_out = (HSRX_DISABLE_in === 1'b0) ?
      o_out : (HSRX_DISABLE_in === 1'bx || HSRX_DISABLE_in === 1'bz) ? 1'bx : 1'b0;

  assign LPRX_O_N_out = (LPRX_DISABLE_in === 1'b0) ?
      lp_out[1] : (LPRX_DISABLE_in === 1'bx || LPRX_DISABLE_in === 1'bz) ? 1'bx : 1'b0;
  assign LPRX_O_P_out = (LPRX_DISABLE_in === 1'b0) ?
      lp_out[0] : (LPRX_DISABLE_in === 1'bx || LPRX_DISABLE_in === 1'bz) ? 1'bx : 1'b0;
  ...
  specify (HSRX_DISABLE => HSRX_O) = (0: 0: 0, 0: 0: 0); (I => HSRX_O) = (0: 0: 0, 0: 0: 0);
      (I => LPRX_O_P) = (0: 0: 0, 0: 0: 0); (IB => HSRX_O) = (0: 0: 0, 0: 0: 0);
      (IB => LPRX_O_N) = (0: 0: 0, 0: 0: 0); (LPRX_DISABLE => LPRX_O_N) = (0: 0: 0, 0: 0: 0);
      (LPRX_DISABLE => LPRX_O_P) = (0: 0: 0, 0: 0: 0); specparam PATHPULSE$ = 0; endspecify
