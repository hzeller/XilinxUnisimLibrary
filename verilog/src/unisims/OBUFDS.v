...
`endif
  ...
  initial begin
    ...
    case (CAPACITANCE)
      ...
      default: begin
        $display(
            "Attribute Syntax Error : The attribute CAPACITANCE on OBUFDS instance %m is set to %s.  Legal values for this attribute are DONT_CARE, LOW or NORMAL."
                , CAPACITANCE);
        #1 $finish;
      end
...
`ifdef XIL_TIMING
  ...
  specify (I => O) = (0: 0: 0, 0: 0: 0); (I => OB) = (0: 0: 0, 0: 0: 0); specparam PATHPULSE$ = 0;
      endspecify
