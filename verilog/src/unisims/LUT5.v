...
`endif
  ...
  always @(I0 or I1 or I2 or I3 or I4) begin
    if ((I0 ^ I1 ^ I2 ^ I3 ^ I4) === 1'b0 || (I0 ^ I1 ^ I2 ^ I3 ^ I4) === 1'b1)
      ...
      O_out = lut_mux4_f({lut_mux8_f(INIT_REG[31:24], {I2, I1, I0}), lut_mux8_f(
                          INIT_REG[23:16], {I2, I1, I0}), lut_mux8_f(INIT_REG[15:8], {I2, I1, I0}),
