...
`ifdef XIL_TIMING
    ...
    $setuphold (negedge CLK, negedge WADR8, 0:0:0, 0:0:0, notifier, we_clk_en_n, we_clk_en_n, CLK_delay, WADR8_delay);
    ...
    $setuphold (negedge CLK, posedge WADR8, 0:0:0, 0:0:0, notifier, we_clk_en_n, we_clk_en_n, CLK_delay, WADR8_delay);
    ...
    $setuphold (posedge CLK, negedge WADR8, 0:0:0, 0:0:0, notifier, we_clk_en_p, we_clk_en_p, CLK_delay, WADR8_delay);
